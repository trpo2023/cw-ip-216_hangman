...
void HangmanGame::Init() {
    ...
    backgroundTexture.loadFromFile("game_background.jpg");
...
void HangmanGame::Draw(sf::RenderWindow& window) {
    ...
    if (attemptsLeft < 6) {
        ...
        ropeBetweenLegs.setPosition(400.f, 60.f); // Позиция между веревкой и телом
    ...
    if (attemptsLeft < 3) {
        ...
        leftArm.setPosition(380.f, 130.f); // Изменил позицию руки
        leftArm.setRotation(-45.f); // Повернул руку вверх
        window.draw(leftArm);
    }
    ...
    if (attemptsLeft < 2) {
        ...
        rightArm.setPosition(450.f, 130.f); // Изменил позицию второй руки
        rightArm.setRotation(45.f); // Повернул руку вверх
    ...
    if (attemptsLeft < 1) {
        ...
        leftLeg.setPosition(390.f, 270.f);
        ...
        rightLeg.setPosition(410.f, 270.f);
